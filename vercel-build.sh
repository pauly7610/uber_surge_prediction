...
# GraphQL API Endpoints (mock for build)
REACT_APP_GRAPHQL_HTTP_URI=https://mock-api.example.com/graphql
REACT_APP_GRAPHQL_WS_URI=wss://mock-api.example.com/graphql
